...
function About() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col mb-7 max-w-full w-[585px] bg-white text-black rounded-lg p-5">
          ...
          <p className="mt-16 text-base max-md:mt-10 max-md:max-w-full">
            ...
            approach, we prioritize the importance of good nutrition and aim to
            promote healthy eating habits among our student community. Surasa is
            also the perfect venue for your special occasions! Whether it's a
            ...
            of your event. Our team of passionate chefs and attentive staff will
            go above and beyond to make your special occasion truly remarkable.
            <br />
            <br />
