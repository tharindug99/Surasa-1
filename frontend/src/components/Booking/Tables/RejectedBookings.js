...
function RejectedBookingRow(props) {
    const { booking } = props;
...
export default function RejectedBookingsTable({ bookings }) {
    const rejectedBookings = bookings.filter(booking => booking.status === 'Rejected');

    return (
        <TableContainer component={Paper}>
            <Table aria-label="rejected-bookings-table">
                <TableHead>
                    <TableRow>
                        <TableCell />
