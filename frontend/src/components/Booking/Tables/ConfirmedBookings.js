...
function ConfirmedBookingRow(props) {
    const { booking } = props;
...
export default function ConfirmedBookingsTable({ bookings }) {
    const confirmedBookings = bookings.filter(booking => booking.status === 'Confirmed');

    return (
        <TableContainer component={Paper}>
            <Table aria-label="confirmed-bookings-table">
                <TableHead>
                    <TableRow>
                        <TableCell />
