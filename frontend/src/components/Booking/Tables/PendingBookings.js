...
function PendingBookingRow(props) {
    const { booking } = props;
...
export default function PendingBookingsTable({ bookings }) {
    // Filter only pending bookings
    const pendingBookings = bookings.filter(booking => booking.status === 'Pending');

    return (
        <TableContainer component={Paper}>
            <Table aria-label="pending-bookings-table">
                <TableHead>
                    <TableRow>
                        <TableCell />
